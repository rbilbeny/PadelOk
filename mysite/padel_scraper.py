...
if __name__=='__main__':
	...
	calendar_url="https://www.clubconecta.cl/Pages/17-CLUB_CONECTA_LAS_CONDES"
	
	id_url="https://www.clubconecta.cl/booking/srvc.aspx/ObtenerCuadros"
	
	API_url="https://www.clubconecta.cl/booking/srvc.aspx/ObtenerCuadro"
	
	
	calendar_url1="http://www.maspadel.cl/Booking/Grid.aspx"
	
	id_url1="http://www.maspadel.cl/booking/srvc.aspx/ObtenerCuadros"
	
	API_url1="http://www.maspadel.cl/booking/srvc.aspx/ObtenerCuadro"
	...
	print("id es: ", id)
	id = 16	
	calendar=get_calendar(API_url,calendar_url,session_id,cheat_code,id,"4/1/2023")
	
	#calendar_ = json.dumps(calendar, indent=4)
	#print(calendar_)

	
	club = calendar["d"]["Nombre"]
